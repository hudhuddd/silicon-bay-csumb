...
/*
output: thorough testing client and then output of assignment-provided client
is at the bottom:
...
|****  *   **** ** *   *   *  * *  |
|**********************************|
  CIS 27B rocks more than Zeppelin
------------------------------------
|* * * * * * * * * * * * * * * * * |
|*                                *|
|****   * ***** **** **** ******** |
...
|** *  * * **   *****  **  *    ** *** |
|**************************************|
Translated back from the image:
  What a great resume builder this is!
*/
